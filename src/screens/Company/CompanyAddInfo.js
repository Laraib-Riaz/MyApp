...
const IndividualAddInfo = ({navigation}) => {
  const {
    control,
    handleSubmit,
  ...
  return (
    <View style={styles.MainContainer}>
      <CustomArrow onPress={() => navigation.goBack()} HeaderName={'Add'} />

      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.FirstBox}>
          <Text style={styles.MainHeading}>Add Information</Text>
        </View>
        <CustomInput
...
export default IndividualAddInfo
