...
const CompanySecurityRep = ({navigation}) => {
  const [data, setData] = useState(Params)

  return (
    <View style={styles.MainConatiner}>
      <CustomArrow onPress={() => navigation.goBack()} HeaderName={'Report'} />
        ...
        <View style={{width: '100%'}}>
          ...
          {data.map((val, key) => {
            return (
              <>
                <TouchableOpacity
                  onPress={() => navigation.navigate('companysrepsetails')}>
...
export default CompanySecurityRep
