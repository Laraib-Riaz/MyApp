...
const IndividualRTabbar = ({navigation}) => {
  ...
  const CreditTwo = () => {
    navigation.navigate('individualRepDetails')
  }
  return (
    <View style={styles.MainContainer}>
      ...
      <TouchableOpacity style={styles.Requests}>
        ...
        <View style={styles.ProfileName}>
          ...
          <Text style={styles.TextName1}>Send you a request.</Text>
        </View>
...
export default IndividualRTabbar
