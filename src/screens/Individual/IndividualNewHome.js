...
const IndividualNewHome = ({navigation}) => {
    ...
    <View style={styles.MainContainer}>
      <View style={styles.Header}>
        ...
        <View style={styles.Part3}>
          <TouchableOpacity
            onPress={() => navigation.navigate('individualeditprofile')}>
            <FontAwesome name="user-circle-o" size={30} color={'#435CA8'} />
          </TouchableOpacity>
        </View>
      </View>
      {/* {!show4 && <Text>OFFICER IS ONSITE</Text>} */}
      {show4 && (
        <View
          style={{
            height: scale(50),
      ...
      {!show2 && (
        <View
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('individualchat2')}
            style={{
              height: scale(50),
              width: scale(50),
...
export default IndividualNewHome
