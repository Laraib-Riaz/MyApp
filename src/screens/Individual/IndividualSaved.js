...
const IndividualSaved = ({navigation}) => {
  ...
  return (
    <View style={styles.MainContainer}>
              ...
              return (
                <View style={styles.BTN}>
                  ...
                  <View style={styles.SecCon}>
                    <TouchableOpacity
                      onPress={() => navigation.navigate('individualeditinfo')}>
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate('individualaddinfo')}
        style={styles.PlusIcon}>
        <Entypo name="plus" size={35} color={'#435CA8'} />
      </TouchableOpacity>
    </View>
  )
}
